...
class Face_Recognition:
    def __init__(self, root):
        ...
        #top image
        img_top = Image.open(r"college_images\face_recog_cover.png")
        ...
        #button
        b1_1 = Button(train_bg_img, text="Face Recognition" ,command=self.face_recog,cursor="hand2",font=("times new roman",25,"bold"),bg="brown",fg="white")
