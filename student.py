...
class Student:
    def __init__(self, root):
        ...
        dep_combo["values"]=("Select Department","Computer","IT","Civil","Mechanical","others")
        dep_combo.current(0)
        ...
        course_combo["values"] = ("Select Course", "BCA", "MCA", "BTECH", "MTECH")
        ...
        class_student_frame = LabelFrame(Left_frame, bd=2, bg="white", relief=RIDGE, text="Student Class Information",
                                          font=("times new roman", 12, "bold"))
        class_student_frame.place(x=5, y=115, width=620, height=300)
        #student ID
        ...
        #class division
        class_div_label = Label(class_student_frame, text="Section", font=("times new roman", 12, "bold"),
                                  bg="white")
        ...
        dob_entry.grid(row=2, column=3, padx=15, pady=5, sticky=W)
        ...
        #mobile no
        phone_label = Label(class_student_frame, text="Mobile No", font=("times new roman", 12, "bold"),
                                bg="white")
        ...
        #asking for photo sample- radio buttons
        ...
        btn_frame.place(x=5,y=210,width=610,height=32)

        save_btn=Button(btn_frame,text="Save",command=self.add_data,width=16,font=("times new roman", 12, "bold"),bg="brown",fg="white")
        save_btn.grid(row=0,column=0)

        update_btn = Button(btn_frame, text="Update", width=16,command=self.update_data, font=("times new roman", 12, "bold"), bg="brown",
                          fg="white")
        update_btn.grid(row=0, column=1)

        delete_btn = Button(btn_frame, text="Delete",command=self.delete_data, width=16, font=("times new roman", 12, "bold"), bg="brown",
                          fg="white")
        delete_btn.grid(row=0, column=2)

        reset_btn = Button(btn_frame, text="Reset",command=self.reset_data, width=16, font=("times new roman", 12, "bold"), bg="brown",
                          fg="white")
        reset_btn.grid(row=0, column=3)

        btn_frame1 = Frame(class_student_frame, bd=2, relief=RIDGE, bg="white")
        btn_frame1.place(x=5, y=242, width=610, height=32)

        take_photo_btn = Button(btn_frame1, text="Take Photo Sample",command=self.generate_dataset, width=33, font=("times new roman", 12, "bold"), bg="brown",
                           fg="white")
        take_photo_btn.grid(row=0, column=0)

        update_sample_btn = Button(btn_frame1, text="Update Photo Sample", width=33, font=("times new roman", 12, "bold"), bg="brown",
                           fg="white")
        update_sample_btn.grid(row=0, column=1)
  
        # right label frame
        Right_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE, text="Student Details",
                                font=("times new roman", 12, "bold"))
        Right_frame.place(x=640, y=5, width=620, height=440)
        img_right = Image.open(r"college_images\student_details_right.png")
        img_right = img_right.resize((620,130), Image.ANTIALIAS)
        self.photoimg_right = ImageTk.PhotoImage(img_right)

        f_lbl = Label(Right_frame, image=self.photoimg_right)
        f_lbl.place(x=5, y=0, width=610, height=130)

    
        #table frame
        table_frame =Frame(Right_frame, bd=2, bg="white", relief=RIDGE)
        table_frame.place(x=5, y=145, width=610, height=260)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="ananya",database="ams")
 ...
 ###   #taking photo samples
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            #loading predefined data on face frontal -opencv
